...
public:
   ...
   */
  DualMotor(int in1, int in2, int in3, int in4, bool reverseA = false,
            bool reverseB = false, int freq = 20000, int resolution = 10);
...
private:
  void driveMotor(int ch1, int ch2, int speed, bool reverse);
