 ...
 * 
 * Usage:
 *   1. 复制此文件到 src/main.cpp 或修改 platformio.ini
 *   2. 编译: pio run
 *   3. 启动 Wokwi: wokwi-cli examples/wokwi/virtual_serial
 *   4. 运行 Python 脚本: python examples/wokwi/virtual_serial/serial_sender.py
 *   5. 在 Wokwi console 中观察输出
 */
